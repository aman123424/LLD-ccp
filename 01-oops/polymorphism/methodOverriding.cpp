// Dynamic Polymorphism (Runtime) -> Happens in different classes with same function name but different implementation. It is achieved through method overriding.
